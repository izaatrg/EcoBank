...
<div class="space-y-6">
    <div class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <div class="space-y-2">
            <h1 class="text-2xl font-semibold text-slate-900">Tambah Warga</h1>
            <p class="text-sm text-slate-500">Isi data warga baru untuk ditambahkan ke dalam sistem EcoBank.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.warga.store') }}" class="mt-8 space-y-6">
            @csrf
