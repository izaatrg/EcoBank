...
<div class="space-y-6">
    <div class="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-2xl font-semibold text-slate-900">Tambah Penukaran Reward</h2>
                <p class="mt-1 text-sm text-slate-500">Form ini siap digunakan ketika backend admin penukaran reward sudah tersedia.</p>
            </div>
            <span class="inline-flex rounded-full bg-amber-100 px-4 py-2 text-sm font-medium text-amber-700">WIP</span>
        </div>
    </div>

    <div class="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200">
        <div class="mb-6 rounded-3xl bg-slate-50 p-4 text-sm text-slate-600 ring-1 ring-slate-200">
            Halaman ini dibuat sebagai placeholder. Tambahkan route dan controller admin untuk mengaktifkan aksi penyimpanan penukaran reward.
        </div>
