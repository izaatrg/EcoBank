...
<div class="space-y-6">
    <div class="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-semibold text-slate-900">Saldo Koin Warga</h2>
                <p class="mt-1 text-sm text-slate-500">Daftar total saldo koin untuk setiap warga.</p>
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-slate-200 text-left text-sm text-slate-700">
                <thead class="bg-slate-50 text-slate-700">
                    <tr>
                        ...
                        <th class="px-6 py-4 font-semibold">Total Koin</th>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    @forelse($saldo as $s)
                    <tr>
                        <td class="px-6 py-4">{{ $s->warga->name ?? '-' }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center text-sm text-slate-500">Tidak ada data saldo koin.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
